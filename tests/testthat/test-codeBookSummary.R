...
test_that("codeBookSummary correct for CategoricalVariable", {
  ...
  cats <- new("Categories", .Data = list(new("Category", .Data = list(1L, 
    FALSE, "Cat", 1L), names = c("id", "missing", "name", "numeric_value"
    )), new("Category", .Data = list(2L, FALSE, "Dog", 2L), names = c("id", 
    "missing", "name", "numeric_value")), new("Category", .Data = list(
    3L, FALSE, "Bird", 3L), names = c("id", "missing", "name", 
    "numeric_value")), new("Category", .Data = list(8L, TRUE, "Skipped", 
    8L), names = c("id", "missing", "name", "numeric_value")), 
    new("Category", .Data = list(9L, TRUE, "Not Asked", 9L), 
    names = c("id", "missing", "name", "numeric_value")), 
    new("Category", .Data = list(-1L, TRUE, "No Data", NULL), 
    names = c("id", "missing", "name", "numeric_value"))))
...
test_that("codeBookSummary correct for MultipleResponseVariable", {
  ...
  tab <- structure(list(name = c("selected", "not selected", "skipped", 
    "not asked"), id = c(1L, 2L, 8L, 9L), missing = c(FALSE, FALSE, 
  ...
  expect_equal(
    r,
    structure(
      list(c("Cat", "Dog", "Bird"), c("Cat",
           "Dog", "Bird"), `1 selected` = rep(1,3),
           `2 not selected` = rep(2,3), `8 skipped` = rep(8,3),
           `9 not asked` = rep(9,3)), row.names = c(NA, -3L),
      class = "data.frame")
  )
})
