...
with_mock_crunch({
  ...
  test_that("Single banner with single variable", {
    ...
    expect_named(banner_data[["Results"]][["___total___"]], c("alias", "name", "old_categories", "categories_out", "categories"))
    expect_named(banner_data[["Results"]][["age5"]], c("alias", "name", "old_categories", "categories_out", "categories"))
  ...
  test_that("Single banner with two variables", {
    ...
    expect_named(banner_data[["Results"]][["___total___"]], c("alias", "name", "old_categories", "categories_out", "categories"))
    expect_named(banner_data[["Results"]][["age5"]], c("alias", "name", "old_categories", "categories_out", "categories"))
    expect_named(banner_data[["Results"]][["allpets"]], c("alias", "name", "old_categories", "categories_out", "categories"))
    expect_identical(banner_data[["Results"]][["age5"]][["alias"]], "age5")
    expect_identical(banner_data[["Results"]][["age5"]][["name"]], "Age 5")
