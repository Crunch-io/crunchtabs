...
test_that("Toplines", {
  ...
  expect_named(crosstabs_data$metadata,
               c("title", "weight", "start_date", "end_date", "description"))
  expect_null(crosstabs_data$banner)
  expect_identical(getName(crosstabs_data),
                   "YouGov crunchtabs_example monkeys (starttime: from 2018-06-19)")
  expect_null(crosstabs_data$metadata$weight)
  expect_named(crosstabs_data$results, c("art3", "books1", "movies1"))
  expect_named(crosstabs_data$results$art3,
               c("alias", "name", "description", "notes", "type", "no_totals", "mean_median",
                 "subnames", "categories", "inserts_obj", "subnumber", "number", "crosstabs"))
  ...
  expect_identical(crosstabs_data$results$art3$description,
                   "Which of these forms of art do you like? Choose all that apply.")
  ...
  x <- structure(
    c(0.528333333333333, 0.511666666666667, 0.521666666666667,
      0.528333333333333, 0.518333333333333),
    class = c("CrunchCubeCalculation", "array"),
    dims = new("CubeDims",
               .Data = list(list(
                 name = c("Painting", "Sculpture", "Dance", "Music", "Poetry"),
                 missing = c(FALSE, FALSE, FALSE, FALSE, FALSE),
                 references = list(
                   alias = "art3",
                   description = "Which of these forms of art do you like? Choose all that apply.",
                   name = "Art Forms Enjoyed",
                   subreferences = list(
                     art3_1 = list(alias = "art3_1", name = "Painting"),
                     art3_2 = list(alias = "art3_2", name = "Sculpture"),
                     art3_3 = list(alias = "art3_3", name = "Dance"),
                     art3_4 = list(alias = "art3_4", name = "Music"),
                     art3_5 = list(alias = "art3_5", name = "Poetry")),
                   type = "subvariable_items",
                   subvariables = c("art3_1/", "art3_2/", "art3_3/", "art3_4/", "art3_5/"))),
                 list(name = "", missing = FALSE,
                      references = list(alias = "total", name = "Total", type = "enum"))),
               names = c(
    "art3",
    "total"
  ...
  expect_equal(
    crosstabs_data$results$art3$crosstabs$Results$`___total___`$proportions, x, tolerance = 1e-7)
...
test_that("Crosstabs", {
  ...
  mockery::stub(crosstabs, "tabBooks",
                readRDS(test_path("fixtures/tabbook_results_crosstab2.rds")))
  ...
  banner_manip <- structure(list(Banner1 = list(`___total___` = structure(list(
    ...
    old_categories = c("Male", "Female"), categories_out = c(
      ...
      Male = 278,
      Female = 322
    ), .Dim = 2L, .Dimnames = list(c("Male", "Female"))),
  ...
  expect_identical(crosstabs_data$results$art2$description,
                   "Which of these forms of art do you like the most?")
...
test_that("nonTabBookSummary end to end via crosstabs", {
  ...
  nonTBS <- structure(list(
    ...
    data_order = c("body", weighted_n = "weighted_n"), inserts = c(
      ...
      weighted_n = structure(list(20L), .Names = NA_character_, class = "data.frame",
