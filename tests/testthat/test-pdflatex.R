# Adding nocov to internal pfdlatex function because
# we ought to favor the more supported/tested tinytex::pdflatex()
#
# test_that("Direct run of tabbook", {
#   file.copy("ref/tabbook1.tex", "tabbook1.tex")
#   crunchtabs:::pdflatex("tabbook1.tex",path.to.pdflatex = paste0(
#     tinytex::tinytex_root(), "/bin/x86_64-linux/pdflatex"))
...
#   crunchtabs:::pdflatex("topline1.tex",path.to.pdflatex = paste0(
#     tinytex::tinytex_root(), "/bin/x86_64-linux/pdflatex"))
